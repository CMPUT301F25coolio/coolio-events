 ...
 *
 * PURPOSE:
 * This class represents an activity for the updating the profile of an organizer.
 * It displays the details of an organizer and gives them options to save their changes
 * or go back from editing.
 *
 * RATIONALE:
 * All of the other buttons on the profile screen become inactive when
 * in the update profile activity. When save button is clicked the new information
 * is updated into firebase.
 *
